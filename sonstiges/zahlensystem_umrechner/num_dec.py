def dec_bin(dec_zahl):
    '''get decimal number and return binary number'''
    bin_liste = []
    bin_zahl = 0

    while dec_zahl != 0:
        bin_liste.append(dec_zahl % 2)
        dec_zahl = dec_zahl // 2
...
def dec_oct(dec_zahl):
    '''get decimal number and return oct number'''
    oct_liste = []
    oct_zahl = 0

    while dec_zahl != 0:
        oct_liste.append(dec_zahl % 8)
        dec_zahl = dec_zahl // 8
...
def dec_hex(dec_zahl):
    ...
    while dec_zahl != 0:
        if dec_zahl % 16 >= 9:
            if dec_zahl % 16 == 10: hex_liste += ("A")
            if dec_zahl % 16 == 11: hex_liste += ("B")
            if dec_zahl % 16 == 12: hex_liste += ("C")
            if dec_zahl % 16 == 13: hex_liste += ("D")
            if dec_zahl % 16 == 14: hex_liste += ("E")
            if dec_zahl % 16 == 15: hex_liste += ("F")
        else:
            hex_liste.append(dec_zahl % 16)
        dec_zahl = dec_zahl // 16
